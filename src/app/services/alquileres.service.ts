...
import { Firestore, collection, addDoc, collectionData, query, where, doc, docData, setDoc, updateDoc, deleteDoc } from '@angular/fire/firestore';
...
export class AlquileresService {
   ...
   */
  getPropertyById(id: string): Observable<Inmueble> {
  ...
  modificarPropiedad(id: string, nuevosDatos: Inmueble) {
    ...
    refInmueble = doc(this.firestore, 'inmuebles', id);
